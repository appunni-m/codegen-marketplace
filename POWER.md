...
Use this power to implement, review, debug, document, and research Rust code.

## Capabilities

- Idiomatic Rust implementation and API design
...
- `skills/rust-development/SKILL.md` - Core implementation and review guidance
- `skills/systematic-debugging/SKILL.md` - Root-cause debugging workflow
- `skills/rust-documentation/SKILL.md` - Rustdoc and public API documentation
- `skills/coding-guidelines/SKILL.md` - Coding standards and lint policy
